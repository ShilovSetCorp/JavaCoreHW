package com.roman.shilov.hw16.travelagency.cities.repo.impl;

import com.roman.shilov.hw16.travelagency.cities.domain.City;
import com.roman.shilov.hw16.travelagency.cities.search.CityOrderByField;

import java.util.*;

import static com.roman.shilov.hw16.travelagency.cities.search.CityOrderByField.NAME;
import static com.roman.shilov.hw16.travelagency.cities.search.CityOrderByField.POPULATION;
import static com.roman.shilov.hw16.travelagency.common.buisness.repo.memory.CommonComparatorHolder.getComparatorForNullableStrings;
import static com.roman.shilov.hw16.travelagency.common.buisness.repo.memory.CommonComparatorHolder.getIntegerComparator;
