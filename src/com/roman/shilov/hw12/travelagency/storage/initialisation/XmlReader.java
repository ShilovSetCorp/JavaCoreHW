...
import static com.roman.shilov.hw12.travelagency.common.solutions.utils.xml.XmlDomUtils.getDocument;
import static com.roman.shilov.hw12.travelagency.common.solutions.utils.xml.XmlDomUtils.getOnlyElement;
...
public class XmlReader implements SourceReader<List<BaseCountry>> {
    ...
    private BaseCountry getCountryFromXml(Node xmlCountry) throws Exception{
    ...
    private City getCityFromXml(Element xmlCity){
        City city = new City();
